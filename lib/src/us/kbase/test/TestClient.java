...
public class TestClient {
     ...
     * validity.
     */
    public TestClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public TestClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * @return   instance of type {@link us.kbase.test.FilterContigsResults FilterContigsResults}
    ...
    public FilterContigsResults filterContigs(FilterContigsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<FilterContigsResults> res = caller.jsonrpcCall("test.filter_contigs", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
}
